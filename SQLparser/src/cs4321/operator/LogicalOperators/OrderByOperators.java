...
/**
 * This class is the logical version of the order by operators.
 * @author messfish
 *
 */
public class OrderByOperators extends UnaryOperators {
	 ...
	 */
	public OrderByOperators(Operators child) {
		super(child);
	}
